...
const Footer = () => {
  return (
    <footer className="py-10 text-slate-200 bg-black px-12 justify-between gap-10 text-sm grid grid-cols-2 md:grid-cols-4">
      {/* Logo */}
      ...
      <div className="flex flex-col gap-4 flex-1">
        ...
        <div className="flex flex-row border border-gray-800 items-center gap-2 px-3 py-2 w-fit rounded-full">
          <input 
            type="email"
            placeholder="Your email"
            className="flex pl-2 bg-gray-950 text-slate-200 focus:outline-none"
          />
          <button>
